...
<!---
| `04_serve_endpoint` | Serve Falcon models with a Databricks serving endpoint.  | `falcon-7b-instruct` | 16GB |
| `05_langchain` | Wrap an endpoint created by `03_serve_driver_proxy` or `04_serve_endpoint` with LangChain and query it. | N/A | N/A |
| `06_fine_tune_deepspeed` | Fine-tune Falcon base models with DeepSpeed. | `falcon-7b` | 160GB |
-->