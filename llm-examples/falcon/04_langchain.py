...
# MAGIC
# MAGIC This example notebook is adapts the [LangChain integration documentation](https://python.langchain.com/docs/modules/model_io/models/llms/integrations/databricks), and shows how to wrap Databricks endpoints as LLMs in LangChain.
# MAGIC
# MAGIC Requirements:
# MAGIC - Keep the driver proxy app of the `03_serve_driver_proxy` example notebook running.
# MAGIC - MLR: 13.1 ML+
# MAGIC - Instance: No actual requirements
...
# TODO: this cluster ID is a placeholder, please replace `cluster_id` with the actual cluster ID of the server proxy app's cluster
