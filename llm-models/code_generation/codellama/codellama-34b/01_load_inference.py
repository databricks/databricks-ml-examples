...
# you can find the commmit history of CodeLlama-34b-hf in
# https://huggingface.co/codellama/CodeLlama-34b-hf/commits/main
...
# it is suggested to pin the revision commit hash and not change it for
# reproducibility because the uploader might change the model afterwards;
# you can find the commmit history of CodeLlama-34b-Instruct-hf in
# https://huggingface.co/codellama/CodeLlama-34b-Instruct-hf/commits/main
...
# it is suggested to pin the revision commit hash and not change it for
# reproducibility because the uploader might change the model afterwards;
# you can find the commmit history of CodeLlama-34b-Python-hf in
# https://huggingface.co/codellama/CodeLlama-34b-Python-hf/commits/main
