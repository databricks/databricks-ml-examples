...
# MAGIC %pip install deepspeed==0.9.5 xformers==0.0.20 torch==2.0.1
...
# --epochs=1 --max-steps=-1 --no-gradient-checkpointing --dbfs-output-dir
# /dbfs/mpt-7b/

# COMMAND ----------

# MAGIC %md
# MAGIC Model checkpoint is saved at `/local_disk0/output`. We save the
# final model to DBFS location `/dbfs/mpt-7b`.
