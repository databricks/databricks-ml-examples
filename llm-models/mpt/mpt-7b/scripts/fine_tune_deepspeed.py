...
def train(
    *,
    ...
    ds_config_dict["zero_optimization"]["reduce_bucket_size"] = model_hidden_size * \
        model_hidden_size
    ds_config_dict["zero_optimization"]["stage3_prefetch_bucket_size"] = 0.9 * \
        model_hidden_size * model_hidden_size
    ds_config_dict["zero_optimization"]["stage3_param_persistence_threshold"] = 10 * \
        model_hidden_size
...
@click.option("--save-steps", type=int, default=400,
...
@click.option("--bf16", type=bool, default=True,
              help="Whether to use bf16 (preferred on A100's).")
def main(**kwargs):
    train(**kwargs)
