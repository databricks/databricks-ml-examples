...
# MAGIC %md
# MAGIC # Load MPT-30B model from LangChain on Databricks
# MAGIC
...
# MAGIC
# MAGIC Prerequisites:
# MAGIC Run `03_serve_driver_proxy` to loaded `MPT-30B-Instruct` model on a Databricks interactive cluster in "single user" or "no isolation shared" mode.
