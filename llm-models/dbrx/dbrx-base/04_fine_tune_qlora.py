...
# MAGIC %md
# MAGIC # Fine tune `dbrx-base` with QLORA
# MAGIC
# MAGIC The [dbrx-base](https://huggingface.co/databricks/dbrx-base) Large Language Model (LLM) is a pretrained generative text model with 131596523520 billion parameters.
# MAGIC
# MAGIC This notebook is to fine-tune [dbrx-base](https://huggingface.co/databricks/dbrx-base) models on the [mosaicml/dolly_hhrlhf](https://huggingface.co/datasets/mosaicml/dolly_hhrlhf) dataset.
# MAGIC
...
model_output_location = "/local_disk0/dbrx-base-lora-fine-tune"
...
# MAGIC
# MAGIC In this section we will load the [dbrx-base](https://huggingface.co/databricks/dbrx-base), quantize it in 4bit and attach LoRA adapters on it.
...
revision = "8c2724d4715132a4a6f3e520cd2b6c6189848c11"
