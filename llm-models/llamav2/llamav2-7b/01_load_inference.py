...
# and accept the license terms and acceptable use policy before submitting
...
# Define prompt template to get the expected features and performance for
# the chat versions. See our reference code in github for details:
