...
# MAGIC %md
# MAGIC # Llama-2-13b-chat-hf Inference on Databricks
# MAGIC
...
# you can find the commmit history of Llama-2-13b-chat-hf in
# https://huggingface.co/meta-llama/Llama-2-13b-chat-hf/commits/main
