...
# MAGIC - Instance: `a2-highgpu-1g` on GCP, `Standard_NC24ads_A100_v4` on Azure, `g5.12xlarge` on AWS
# MAGIC
# MAGIC We will leverage PEFT library from Hugging Face ecosystem, as well
# as QLoRA for more memory efficient finetuning.
...
# MAGIC
# MAGIC In this section we will load LLaMAV2, quantize it in 4bit and
# attach LoRA adapters on it.
...
peft_config = LoraConfig(
    ...
    target_modules=[
        ...
        'down_proj',
        'k_proj',
        'v_proj']  # Choose all linear layers from the model
)
...
trainer.save_model("/local_disk0/llamav2-13b-lora-fine-tune")
...
peft_model_id = "/local_disk0/llamav2-13b-lora-fine-tune"
