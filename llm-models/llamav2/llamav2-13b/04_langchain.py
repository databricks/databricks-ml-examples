...
# MAGIC   - Wrapping a cluster driver proxy app: `g5.12xlarge` on AWS,
# `Standard_NV72ads_A10_v5` or `Standard_NC24ads_A100_v4` on Azure (same
# instance as the driver proxy app)
