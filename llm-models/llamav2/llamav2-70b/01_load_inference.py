...
# MAGIC %md
# MAGIC # Llama-2-70b-chat-hf Inference on Databricks
# MAGIC
...
# MAGIC %pip install -U git+https://github.com/huggingface/transformers.git  git+https://github.com/huggingface/accelerate.git
...
# you can find the commmit history of Llama-2-70b-chat-hf in
# https://huggingface.co/meta-llama/Llama-2-70b-chat-hf/commits/main
