...
# MAGIC %md
# MAGIC # Fine tune `falcon-7b` with QLORA
# MAGIC
# MAGIC The [falcon-7b](https://huggingface.co/tiiuae/falcon-7b) Large Language Model (LLM) is a pretrained generative text model with 7 billion parameters.
# MAGIC
# MAGIC This notebook is to fine-tune [falcon-7b](https://huggingface.co/tiiuae/falcon-7b) models on the [mosaicml/dolly_hhrlhf](https://huggingface.co/datasets/mosaicml/dolly_hhrlhf) dataset.
# MAGIC
...
model_output_location = "/local_disk0/falcon-7b-lora-fine-tune"
...
# MAGIC
# MAGIC In this section we will load the [falcon-7b](https://huggingface.co/tiiuae/falcon-7b), quantize it in 4bit and attach LoRA adapters on it.
