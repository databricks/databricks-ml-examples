...
# Assuming your DataFrame is named 'df' and the column with strings is
# named 'col_with_colon'
df = df.withColumn(
    'diffusion_prompt',
    split(
        df['description'],
        ':').getItem(1)).drop('description').withColumn(
            "id",
...
Image.open(
    '/dbfs/FileStore/shared_uploads/avinash.sooriyarachchi@databricks.com/fashion_images/239.png')
...
# MAGIC %sh
# MAGIC cat
# '/dbfs/FileStore/shared_uploads/avinash.sooriyarachchi@databricks.com/fashion_images/metadata.csv'
