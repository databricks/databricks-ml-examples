...
# MAGIC
# MAGIC You can use sentence-transformers with the bge-large-en model to
...
# MAGIC %md
# MAGIC For s2p(short query to long passage) retrieval task, each short
# query should start with an instruction `Represent this sentence for
