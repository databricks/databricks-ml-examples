...
# MAGIC %md
# MAGIC
# MAGIC # Build vector database with `bge-m3`
# MAGIC
# MAGIC This notebook demostrates how to build a vector store with [faiss](https://github.com/facebookresearch/faiss) using [bge-m3 model](https://huggingface.co/BAAI/bge-m3).
# MAGIC
...
volume_location = "/Volumes/main/default/llm"
vector_store.save_local(folder_path=volume_location)
