...
# MAGIC * Upgrade `xformers` to accelerate training with memory-efficient
# attention.
...
def generate_and_measure_throughput(prompt, **kwargs):
    ...
    return ((num_output_tokens - num_input_tokens) / duration,
            (num_output_tokens - num_input_tokens), result)

# COMMAND ----------


throughput, n_tokens, result = generate_and_measure_throughput(
    ["Write me travel blog to Colorado in fall"])
