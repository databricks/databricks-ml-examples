...
| Text embeddings (English only)   | [bge-large-en(1.3B)](https://huggingface.co/BAAI/bge-large-en) <br> [instructor-xl (1.3B)](https://huggingface.co/hkunlp/instructor-xl)  |  [bge-base-en (0.4B)] (https://huggingface.co/BAAI/bge-base-en) <br> [e5-large-v2 (0.3B)](https://huggingface.co/intfloat/e5-large-v2) | [ge-small-en (0.1B)](https://huggingface.co/BAAI/bge-small-en) <br> [e5-base-v2 (0.1B)](https://huggingface.co/intfloat/e5-large-v2) |
